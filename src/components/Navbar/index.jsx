    ...
    return(
        <nav className="navbar_container">
            ...
            <ul className={isNavbarActive}>
                ...
                <li className="navbar_item"><a href="#" className="navbar_link">Lucas Araújo</a></li>
                <li className="navbar_item"><a href="#" className="navbar_link">Cursos e Treinamentos</a></li>
                <li className="navbar_item"><a href="#" className="navbar_link">Agende um horário comigo</a></li>
            </ul>
